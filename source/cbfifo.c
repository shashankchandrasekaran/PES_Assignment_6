 ...
 *  Reference: 1) https://github.com/alexander-g-dean/ESF/blob/master/NXP/Code/Chapter_8/Serial-Demo/src/queue.c
...
{
	return Q_MAX_SIZE; //Returns size of array i.e. 256
}
